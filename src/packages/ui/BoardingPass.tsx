...
export function BoardingPass({
  ...
  return (
    <>
      ...
      {/* Footer disclaimer */}
      <div className="bg-zinc-900/90 px-6 py-2.5 text-[10px] text-zinc-500 flex flex-col sm:flex-row items-center justify-between border-t border-white/10 gap-1 text-center sm:text-left">
        <span>GATE: MIND-42 &bull; SEAT: 1A &bull; GROUP: ZERO</span>
        <span className="text-zinc-400 font-bold tracking-wider">FICTIONAL PASS &bull; NOT A VALID TRAVEL DOCUMENT</span>
      </div>
    </div>
    <p className="mt-3 text-[10px] font-mono text-zinc-500 text-center leading-relaxed max-w-xl">
